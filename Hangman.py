...
photos = [PhotoImage(file="https://upload.wikimedia.org/wikipedia/commons/8/8b/Hangman-0.png"), PhotoImage(file="images/hang1.png"), PhotoImage(file="images/hang2.png"), PhotoImage(file="images/hang3.png"),
